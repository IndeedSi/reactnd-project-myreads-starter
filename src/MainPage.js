...
class MainPage extends React.Component {
    render() {
        const {books, shelves, getShelfTitle, onUpdateShelf} = this.props;
        ...
        return (<div className="list-books">
            ...
            <div className="list-books-content">
                <div>
                    { shelves.map((shelf) =>
                        (<BookShelf key={shelf} books={shelvesToBooks[shelf]} shelf={shelf} shelves={shelves} getShelfTitle={getShelfTitle}
